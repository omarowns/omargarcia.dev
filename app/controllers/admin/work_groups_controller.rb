module Admin
  class WorkGroupsController < ApplicationController
    ...
    def create
      ...
      if @work_group.save
        redirect_to [:admin, @work_group], notice: 'Work group was successfully created.'
      else
        render :new
      end
    end
    ...
    def update
      if @work_group.update(work_group_params)
        redirect_to [:admin, @work_group], notice: 'Work group was successfully updated.'
      else
        render :edit
      end
    end
    ...
    def destroy
      @work_group.destroy
      redirect_to admin_work_groups_url, notice: 'Work group was successfully destroyed.'
    end
