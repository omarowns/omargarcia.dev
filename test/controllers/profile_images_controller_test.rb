...
class ProfileImagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profile_image" do
    assert_difference('ProfileImage.count') do
      post profile_profile_images_url(@profile), params: { profile_image: { featured: @profile_image.featured, image_id: @profile_image.image_id, main: @profile_image.main, position: @profile_image.position, profile_id: @profile_image.profile_id } }
    end
